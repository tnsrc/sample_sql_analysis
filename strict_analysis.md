...
**Chunking Strategy**: Strict Logical
...
- **Average Complexity per Chunk**: 40.6
...
4. **Chunk 4**: Variable & Parameter Declarations
   - Type: variable_declaration
   - Complexity: 0
   - Lines: 36-178
   - Context: Follows general logic

5. **Chunk 5**: Variable & Parameter Declarations (EXEC/SELECT)
   - Type: variable_declaration
   - Complexity: 287
   - Lines: 179-1189
   - Context: Performs exec, select, update, insert operations. Uses for, end, case, return, catch, when, try, begin, if, else, goto, while logic. Follows variable declaration

6. **Chunk 6**: General Business Logic
   - Type: general_logic
   - Complexity: 0
   - Lines: 1190-1195
   - Context: Follows variable declaration

7. **Chunk 7**: Conditional Logic & Branching (END/RETURN)
   - Type: conditional_logic
   - Complexity: 35
   - Lines: 1196-1237
   - Context: Uses end, return, begin, if, else logic. Follows general logic

8. **Chunk 8**: General Business Logic (END/RETURN)
   - Type: general_logic
   - Complexity: 0
   - Lines: 1238-1241
...
### Chunk 4: Variable & Parameter Declarations
**Type**: variable_declaration
**Complexity Score**: 0
**Lines**: 36-178
**Context**: Follows general logic
**Variables Declared**: @LOCALTAXRATE, @TOTALVOLUME, @APPLIEDPROMOTIONS, @REWARDSCASHBACK, @INVENTORYRESERVATIONID, @STATETAXRATE, @PROCESSINGFEE, @TOTALWEIGHT, @LOYALTYPOINTSEARNED, @PAYMENTREFERENCENUMBER
   (and 67 more...)
...
### Chunk 5: Variable & Parameter Declarations (EXEC/SELECT)
**Type**: variable_declaration
**Complexity Score**: 287
**Lines**: 179-1189
**Context**: Performs exec, select, update, insert operations. Uses for, end, case, return, catch, when, try, begin, if, else, goto, while logic. Follows variable declaration
**SQL Operations**: EXEC, SELECT, UPDATE, INSERT
**Control Structures**: FOR, END, CASE, RETURN, CATCH, WHEN, TRY, BEGIN, IF, ELSE, GOTO, WHILE
**Variables Declared**: @LINETAXAMOUNT, @ALLOCATEDTOTAL, @POINTSTOREDEEM, @TIERDISCOUNT, @TIERDISCOUNTPERCENTAGE, @PRODUCTTAXRATE, @NEWCUSTOMERTIERID, @POINTSDISCOUNT, @MAXPOINTSREDEMPTION
**Tables/Views**: ORDERITEMS, LOYALTYTRANSACTIONS, DAILYSALESSUMMARY, ORDERPROMOTIONS, PAYMENTMETHODS, CUSTOMERS, SHIPPINGMETHODZONES, CUSTOMERPAYMENTMETHODS, OPENJSON, CUSTOMERTIERS, INVENTORYRESERVATIONS, ADDRESSES, ERRORLOG, ORDERS, TIER, PRODUCTS, TRANSACTIONLOG, AUDITLOG, NOTIFICATIONQUEUE, PROMOTIONS, CUSTOMERANALYTICS, CUSTOMERRECOMMENDATIONS, PAYMENTS, P, CUSTOMERLOG, SHIPPINGMETHODS
...
### Chunk 6: General Business Logic
**Type**: general_logic
**Complexity Score**: 0
**Lines**: 1190-1195
**Context**: Follows variable declaration
...
### Chunk 7: Conditional Logic & Branching (END/RETURN)
**Type**: conditional_logic
**Complexity Score**: 35
**Lines**: 1196-1237
**Context**: Uses end, return, begin, if, else logic. Follows general logic
**Control Structures**: END, RETURN, BEGIN, IF, ELSE
...
### Chunk 8: General Business Logic (END/RETURN)
**Type**: general_logic
**Complexity Score**: 0
**Lines**: 1238-1241
**Context**: Uses end, return logic. Follows conditional logic
